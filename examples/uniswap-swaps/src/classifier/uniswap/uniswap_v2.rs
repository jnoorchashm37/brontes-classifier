use crate::classifier::Actions;
use crate::classifier::Protocol;
use crate::classifier::Swap;
use crate::classifier::abis::UniswapV2;
...
action_impl!(
    (crate::classifier::Protocol, Actions),
    crate::classifier::Protocol::UniswapV2,
    UniswapV2::swapCall,
    Swap,
    [..Swap],
    call_data: true,
